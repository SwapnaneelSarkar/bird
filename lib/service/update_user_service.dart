...
class UpdateUserService {
  ...
  // Add this method to the UpdateUserService class
// Add this method to UpdateUserService class
Future<Map<String, dynamic>> updateUserProfileWithId({
  required String token,
  ...
  try {
    debugPrint('UpdateUserService: Starting profile update with user_id...');
    debugPrint('UpdateUserService: Token: $token');
    debugPrint('UpdateUserService: User ID: $userId');
    ...
    // Add user_id field - only required field
...
// Also update the uploadProfileImage method to use user_id
Future<Map<String, dynamic>> uploadProfileImage({
  ...
  try {
    ...
    // Add user_id field instead of mobile
    request.fields['user_id'] = userId;
