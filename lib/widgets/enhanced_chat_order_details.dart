...
class EnhancedChatOrderDetails extends StatelessWidget {
  final OrderDetails orderDetails;
  final VoidCallback? onCancelOrder;
  final Map<String, Map<String, dynamic>> menuItemDetails;

  const EnhancedChatOrderDetails({
    Key? key,
  ...
  Widget build(BuildContext context) {
    debugPrint('EnhancedChatOrderDetails: 🎨 Building enhanced chat order widget');
    debugPrint('EnhancedChatOrderDetails: 📋 Order ID: ${orderDetails.orderId}');
    debugPrint('EnhancedChatOrderDetails: 📅 Created at: ${orderDetails.createdAt}');
    debugPrint('EnhancedChatOrderDetails: 📅 Formatted date: ${orderDetails.formattedCreatedDateTime}');
    debugPrint('EnhancedChatOrderDetails: 🎯 Status: ${orderDetails.orderStatus}');
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Header with restaurant name, order date/time, and status
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Restaurant name and status row
                Row(
                  children: [
                    Expanded(
                      child: Text(
